...
var author$project$Effects$name = function (_n0) {
	var eff = _n0.a;
	return eff.name;
};
...
var author$project$Interop$midiInput = _Platform_incomingPort('midiInput', elm$json$Json$Decode$value);
var author$project$Messages$AnimationFrameTriggered = function (a) {
	return {$: 'AnimationFrameTriggered', a: a};
};
var author$project$Messages$MidiInputReceived = function (a) {
	return {$: 'MidiInputReceived', a: a};
};
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				elm$browser$Browser$Events$onAnimationFrame(author$project$Messages$AnimationFrameTriggered),
								...
								case 'CloudEffect':
									if (_n7.b.$ === 'CloudMod') {
										...
										return _Utils_update(
											model,
											{
												currentEffect: author$project$Messages$CloudEffect(
								...
								case 'LightningEffect':
									if (_n7.b.$ === 'LightningMod') {
										...
										return _Utils_update(
											model,
											{
												currentEffect: author$project$Messages$LightningEffect(
													A3(author$project$Effects$applyModifier, eff, mod_, val))
											});
									} else {
										break _n7$3;
							...
							otherEffects: A2(
								...
								A2(
									...
									function (otherEff) {
										switch (eff.$) {
											case 'CloudEffect':
												if (otherEff.$ === 'CloudEffect') {
													return false;
												} else {
													return true;
												}
											case 'LightningEffect':
												if (otherEff.$ === 'LightningEffect') {
													return false;
												} else {
													return true;
												}
...
var author$project$Clouds$EffectView$curve = F3(
	function (_n0, _n1, _n2) {
		var x1 = _n0.a;
		var y1 = _n0.b;
		var x2 = _n1.a;
		...
		var x = _n2.a;
		var y = _n2.b;
		return 'C ' + (elm$core$String$fromFloat(x1) + (' ' + (elm$core$String$fromFloat(y1) + (',' + (elm$core$String$fromFloat(x2) + (' ' + (elm$core$String$fromFloat(y2) + (',' + (elm$core$String$fromFloat(x) + (' ' + elm$core$String$fromFloat(y)))))))))));
	});
...
var author$project$Clouds$EffectView$drawCloud = F2(
	function (rowHeight, cloud) {
		return A2(
			elm_community$typed_svg$TypedSvg$svg,
			_List_fromArray(
				[
					elm_community$typed_svg$TypedSvg$Attributes$height(
					elm_community$typed_svg$TypedSvg$Types$px(rowHeight)),
					elm_community$typed_svg$TypedSvg$Attributes$width(
					elm_community$typed_svg$TypedSvg$Types$px(cloud.width)),
					elm_community$typed_svg$TypedSvg$Attributes$x(
					elm_community$typed_svg$TypedSvg$Types$px(cloud.x))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							('M ' + (elm$core$String$fromFloat((cloud.width / 2) * cloud.corners.topLeft.horizontalLength) + ',0')) + ((' H ' + elm$core$String$fromFloat(cloud.width - ((cloud.width / 2) * cloud.corners.topRight.horizontalLength))) + (' ' + (A3(
								author$project$Clouds$EffectView$curve,
								_Utils_Tuple2(cloud.width - (((cloud.width / 2) * cloud.corners.topRight.horizontalLength) * cloud.corners.topRight.firstControlPointX), 0),
								_Utils_Tuple2(cloud.width, (rowHeight / 2) * cloud.corners.topRight.secondControlPointY),
								_Utils_Tuple2(cloud.width, rowHeight / 2)) + (A3(
								author$project$Clouds$EffectView$curve,
								_Utils_Tuple2(cloud.width, (rowHeight / 2) + ((rowHeight / 2) * cloud.corners.bottomRight.secondControlPointY)),
								_Utils_Tuple2(cloud.width - (((cloud.width / 2) * cloud.corners.bottomRight.horizontalLength) * cloud.corners.bottomRight.firstControlPointX), rowHeight),
								_Utils_Tuple2(cloud.width - ((cloud.width / 2) * cloud.corners.bottomRight.horizontalLength), rowHeight)) + (' H ' + (elm$core$String$fromFloat((cloud.width / 2) * cloud.corners.bottomLeft.horizontalLength) + (A3(
								author$project$Clouds$EffectView$curve,
								_Utils_Tuple2(((cloud.width / 2) * cloud.corners.bottomLeft.horizontalLength) * cloud.corners.bottomLeft.firstControlPointX, rowHeight),
								_Utils_Tuple2(0, rowHeight - ((rowHeight / 2) * cloud.corners.bottomLeft.secondControlPointY)),
								_Utils_Tuple2(0, rowHeight / 2)) + (A3(
								author$project$Clouds$EffectView$curve,
								_Utils_Tuple2(0, (rowHeight / 2) * cloud.corners.topLeft.secondControlPointY),
								_Utils_Tuple2(((cloud.width / 2) * cloud.corners.topLeft.horizontalLength) * cloud.corners.topLeft.firstControlPointX, 0),
								_Utils_Tuple2((cloud.width / 2) * cloud.corners.topLeft.horizontalLength, 0)) + ' Z'))))))))),
...
var author$project$Clouds$EffectView$drawCloudRow = function (row) {
	return A2(
		elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					author$project$Clouds$EffectView$drawCloud(row.height),
					row.clouds))
			]));
};
...
var elm_community$typed_svg$TypedSvg$Attributes$gradientTransform = function (transforms) {
	return A2(
		elm_community$typed_svg$TypedSvg$Core$attribute,
		'gradientTransform',
		A2(
...
var author$project$Clouds$EffectView$draw = function (model) {
	return A2(
		elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$id('gradient'),
								elm_community$typed_svg$TypedSvg$Attributes$gradientTransform(
								_List_fromArray(
									[
										A3(elm_community$typed_svg$TypedSvg$Types$Rotate, 90, 0, 0)
									]))
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										elm_community$typed_svg$TypedSvg$Attributes$stopColor('#7593ab')
									]),
								_List_Nil),
								A2(
								elm_community$typed_svg$TypedSvg$stop,
								_List_fromArray(
									[
										elm_community$typed_svg$TypedSvg$Attributes$offset('15%'),
										elm_community$typed_svg$TypedSvg$Attributes$stopColor('#cbc3c1')
									]),
								_List_Nil),
								A2(
								elm_community$typed_svg$TypedSvg$stop,
								_List_fromArray(
									[
										elm_community$typed_svg$TypedSvg$Attributes$offset('25%'),
										elm_community$typed_svg$TypedSvg$Attributes$stopColor('#cbc3c1')
									]),
								_List_Nil),
								A2(
								...
								_List_fromArray(
									[
										elm_community$typed_svg$TypedSvg$Attributes$offset('30%'),
										elm_community$typed_svg$TypedSvg$Attributes$stopColor('#cab0ac')
									]),
								_List_Nil),
								A2(
								elm_community$typed_svg$TypedSvg$stop,
								_List_fromArray(
									[
										elm_community$typed_svg$TypedSvg$Attributes$offset('35%'),
										elm_community$typed_svg$TypedSvg$Attributes$stopColor('#8ea5ba')
									]),
								_List_Nil),
								A2(
								elm_community$typed_svg$TypedSvg$stop,
								_List_fromArray(
									[
										elm_community$typed_svg$TypedSvg$Attributes$offset('65%'),
										elm_community$typed_svg$TypedSvg$Attributes$stopColor('#afbdc6')
									]),
								_List_Nil),
								A2(
								elm_community$typed_svg$TypedSvg$stop,
								_List_fromArray(
									[
										...
										elm_community$typed_svg$TypedSvg$Attributes$stopColor('#001a66')
									]),
								_List_Nil)
							]))
					])),
				...
				_List_fromArray(
					[
						...
						elm_community$typed_svg$TypedSvg$Types$px(0)),
						elm_community$typed_svg$TypedSvg$Attributes$y(
						elm_community$typed_svg$TypedSvg$Types$px(260))
					]),
				A2(elm$core$List$map, author$project$Clouds$EffectView$drawCloudRow, model.cloudRows))
			]));
};
var author$project$Clouds$Model$CornerInfo = F3(
	function (horizontalLength, firstControlPointX, secondControlPointY) {
		return {firstControlPointX: firstControlPointX, horizontalLength: horizontalLength, secondControlPointY: secondControlPointY};
	});
...
var author$project$Clouds$Model$cornerGenerator = function (extremity) {
	return A4(
		elm$random$Random$map3,
		author$project$Clouds$Model$CornerInfo,
		A2(elm$random$Random$float, 0.6 * extremity, 1 * extremity),
		A2(elm$random$Random$float, 0.8 * extremity, extremity + 1),
		A2(elm$random$Random$float, 0, 1.2 * extremity));
};
...
var author$project$Clouds$Model$buildCloud = function (_n0) {
	var totalWidth = _n0.totalWidth;
	var allocatedWidth = _n0.allocatedWidth;
	var seed = _n0.seed;
	var extremity = _n0.extremity;
	if (_Utils_cmp(allocatedWidth, totalWidth) > -1) {
		return elm$core$Maybe$Nothing;
	} else {
		var _n1 = A2(
			...
			seed);
		var cloudWidth = _n1.a;
		var seed1 = _n1.b;
		var _n2 = A2(
			elm$random$Random$step,
			author$project$Clouds$Model$cornerGenerator(extremity),
			seed1);
		var topLeftCorner = _n2.a;
		var seed2 = _n2.b;
		var _n3 = A2(
			elm$random$Random$step,
			author$project$Clouds$Model$cornerGenerator(extremity),
			seed2);
		var topRightCorner = _n3.a;
		var seed3 = _n3.b;
		var _n4 = A2(
			elm$random$Random$step,
			author$project$Clouds$Model$cornerGenerator(extremity),
			seed3);
		var bottomLeftCorner = _n4.a;
		var seed4 = _n4.b;
		var _n5 = A2(
			elm$random$Random$step,
			author$project$Clouds$Model$cornerGenerator(extremity),
			seed4);
		var bottomRightCorner = _n5.a;
		var seed5 = _n5.b;
		return elm$core$Maybe$Just(
			_Utils_Tuple2(
				{
					corners: {bottomLeft: bottomLeftCorner, bottomRight: bottomRightCorner, topLeft: topLeftCorner, topRight: topRightCorner},
					width: cloudWidth,
					x: allocatedWidth
				},
				{allocatedWidth: (allocatedWidth + cloudWidth) + 2, extremity: extremity, seed: seed5, totalWidth: totalWidth}));
	}
};
...
var author$project$Clouds$Model$buildCloudRow = F3(
	function (extremity, windowWidth, seed) {
		return {
			clouds: A2(
				elm_community$list_extra$List$Extra$unfoldr,
				author$project$Clouds$Model$buildCloud,
				{allocatedWidth: 0, extremity: extremity, seed: seed, totalWidth: windowWidth}),
			height: 10,
			opacity: 0,
			xScale: 1,
			y: 1,
...
var author$project$Clouds$Model$init = function (flags) {
	var width = flags.window.width - 200;
	var seed = elm$random$Random$initialSeed(flags.time);
	return {
		cloudRows: _List_fromArray(
			[
				A3(author$project$Clouds$Model$buildCloudRow, 0.5, width, seed)
			]),
		extremity: 0.5,
		speed: 0.5,
		window: flags.window
...
var author$project$Clouds$Update$tick = F2(
	function (time, model) {
		var seed0 = elm$random$Random$initialSeed(
			elm$time$Time$posixToMillis(time));
		var newCloudRows = function () {
			var _n0 = elm$core$List$head(model.cloudRows);
			if (_n0.$ === 'Just') {
				var firstRow = _n0.a;
				return (firstRow.y >= 15) ? _Utils_ap(
					_List_fromArray(
						[
							A3(author$project$Clouds$Model$buildCloudRow, model.extremity, model.window.width, seed0)
						]),
					model.cloudRows) : model.cloudRows;
			} else {
				return model.cloudRows;
			}
		}();
		return _Utils_update(
			model,
			{
				cloudRows: A2(
					...
					A2(
						elm$core$List$map,
						author$project$Clouds$Update$updateCloudRow(model),
						newCloudRows))
			});
	});
...
var author$project$Lightning$EffectView$arcColor = A3(avh4$elm_color$Color$rgb, 1, 1, 1);
...
var author$project$Lightning$EffectView$drawArc = F2(
	function (_n0, _n1) {
		var x = _n0.x;
		var y = _n0.y;
		var arc = _n1.a;
		...
		return _Utils_ap(
				...
				[
					...
					_List_fromArray(
						[
							...
							elm_community$typed_svg$TypedSvg$Attributes$stroke(author$project$Lightning$EffectView$arcColor)
						]),
					_List_Nil)
				]),
			elm$core$List$concat(
				A2(
					elm$core$List$map,
					author$project$Lightning$EffectView$drawArc(
						{x: endX, y: endY}),
					arc.arcs)));
	});
var author$project$Lightning$EffectView$drawBolt = function (bolt) {
	return elm$core$List$concat(
		A2(
			elm$core$List$map,
			author$project$Lightning$EffectView$drawArc(bolt.origin),
			bolt.arcs));
};
var author$project$Lightning$EffectView$draw = function (model) {
	return A2(
		elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
		...
		_Utils_ap(
			...
			elm$core$List$concat(
				A2(elm$core$List$map, author$project$Lightning$EffectView$drawBolt, model.bolts))));
};
var author$project$Lightning$Model$init = function (flags) {
	return {bolts: _List_Nil, chaos: 0.5, dilation: 0.5, fremulation: 0.5, window: flags.window, zoom: 0.5};
};
var author$project$Lightning$Model$Arc = function (a) {
	return {$: 'Arc', a: a};
};
var author$project$Lightning$Update$arcLength = function (model) {
	return A2(elm$random$Random$float, (8 * model.zoom) + 1, (30 * model.zoom) + 2);
};
var author$project$Lightning$Update$probability = A2(elm$random$Random$float, 0, 1);
...
var author$project$Lightning$Update$iterateArc = F3(
	function (model, seed, _n0) {
		var arc = _n0.a;
		if (elm$core$List$isEmpty(arc.arcs)) {
			var _n1 = A2(elm$random$Random$step, author$project$Lightning$Update$probability, seed);
			...
			var _n2 = A2(
				...
				A2(
					...
					A2(
						...
						author$project$Lightning$Update$arcLength(model),
						A2(elm$random$Random$float, arc.angle - 1.5, arc.angle + 1.5))),
				seed1);
			var arcVals = _n2.a;
			var seed2 = _n2.b;
			return author$project$Lightning$Model$Arc(
				_Utils_update(
					arc,
					{
						arcs: A2(
							...
							function (_n3) {
								var length = _n3.a;
								var angle = _n3.b;
								return (arcNum === 1) ? author$project$Lightning$Model$Arc(
									{angle: angle + ((arc.origAngle - angle) / 3), arcs: _List_Nil, length: length, origAngle: arc.origAngle}) : author$project$Lightning$Model$Arc(
					...
					arc,
					{
						arcs: A2(
							...
							function (_n5) {
								var subArc = _n5.a;
								var newSeed = _n5.b;
								return A3(author$project$Lightning$Update$iterateArc, model, newSeed, subArc);
							},
							A2(elm_community$list_extra$List$Extra$zip, arc.arcs, seeds))
					}));
		}
	});
var author$project$Lightning$Update$iterateBolt = F2(
	function (model, bolt) {
		var _n0 = A2(elm$random$Random$step, author$project$Lightning$Update$probability, bolt.seed);
					...
					bolt,
					{
						arcs: A2(
							...
							function (_n2) {
								var arc = _n2.a;
								var newSeed = _n2.b;
								return A3(author$project$Lightning$Update$iterateArc, model, newSeed, arc);
							},
...
var author$project$Lightning$Update$makeNewBolt = F3(
	function (model, seed, coords) {
		var _n0 = A2(elm$random$Random$step, author$project$Lightning$Update$probability, seed);
...
var author$project$Lightning$Model$Coords = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var author$project$Lightning$Update$randomScreenPos = function (dims) {
	return A3(
		elm$random$Random$map2,
		author$project$Lightning$Model$Coords,
...
var author$project$Lightning$Update$randomScreenPosWithoutOverlap = F3(
	function (dims, points, distance) {
		return A2(
			...
			author$project$Lightning$Update$randomScreenPos(dims));
	});
var author$project$Lightning$Update$generateBolts = F2(
	function (seed, model) {
		if (elm$core$List$isEmpty(model.bolts)) {
			var _n0 = A2(
				elm$random$Random$step,
				author$project$Lightning$Update$randomScreenPos(model.window),
				seed);
			var boltPos = _n0.a;
			var seed1 = _n0.b;
			return _List_fromArray(
				[
					A3(author$project$Lightning$Update$makeNewBolt, model, seed1, boltPos)
				]);
		} else {
			...
			var _n2 = A2(
				...
				A2(
					...
					A2(
						elm$random$Random$pair,
						elm$random$Random$independentSeed,
						A3(author$project$Lightning$Update$randomScreenPosWithoutOverlap, model.window, currentBoltPositions, 300))),
				seed1);
			...
			var newBolts = A2(
				...
				function (_n3) {
					var newSeed = _n3.a;
					var pos = _n3.b;
					return A3(author$project$Lightning$Update$makeNewBolt, model, newSeed, pos);
				},
				newBoltVars);
			return A2(
				elm$core$List$filterMap,
				author$project$Lightning$Update$iterateBolt(model),
				_Utils_ap(model.bolts, newBolts));
		}
	});
var author$project$Lightning$Update$tick = F2(
	function (time, model) {
		var seed0 = elm$random$Random$initialSeed(
			elm$time$Time$posixToMillis(time));
		return _Utils_update(
			model,
			{
				bolts: A2(author$project$Lightning$Update$generateBolts, seed0, model)
			});
	});
var author$project$Messages$Chaos = {$: 'Chaos'};
var author$project$Messages$CloudMod = function (a) {
	return {$: 'CloudMod', a: a};
};
var author$project$Messages$Dilation = {$: 'Dilation'};
var author$project$Messages$Extremity = {$: 'Extremity'};
var author$project$Messages$Fremulation = {$: 'Fremulation'};
var author$project$Messages$LightningMod = function (a) {
	return {$: 'LightningMod', a: a};
};
var author$project$Messages$NoiseMod = function (a) {
	return {$: 'NoiseMod', a: a};
};
...
var author$project$Perlin$grad = F2(
	function (hash, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		var z = _n0.c;
...
var author$project$Perlin$lerp = function (_n0) {
	var a = _n0.a;
	var b = _n0.b;
	var x = _n0.c;
	return a + (x * (b - a));
...
var author$project$Perlin$noise = F2(
	function (_n0, seed0) {
		...
		var _n1 = _Utils_Tuple3(
			255 & elm$core$Basics$floor(x),
			255 & elm$core$Basics$floor(y),
			255 & elm$core$Basics$floor(z));
		var xi = _n1.a;
		var yi = _n1.b;
		var zi = _n1.c;
		var _n2 = _Utils_Tuple3(
			x - elm$core$Basics$floor(x),
			y - elm$core$Basics$floor(y),
			z - elm$core$Basics$floor(z));
		var xf = _n2.a;
		var yf = _n2.b;
		var zf = _n2.c;
		var _n3 = _Utils_Tuple3(
			author$project$Perlin$fade(xf),
			author$project$Perlin$fade(yf),
			author$project$Perlin$fade(zf));
		var u = _n3.a;
		var v = _n3.b;
		var w = _n3.c;
		var _n4 = A2(
			...
			seed0);
		var permutation = _n4.a;
		var seed1 = _n4.b;
		var p = function (_int) {
			return A2(
				elm$core$Maybe$withDefault,
				0,
				A2(elm_community$list_extra$List$Extra$getAt, _int, permutation));
		};
		var aaa = p(
			p(
				p(xi) + yi) + zi);
		...
		var baa = p(
			p(
				p(xi + 1) + yi) + zi);
		var x1 = author$project$Perlin$lerp(
			_Utils_Tuple3(
				A2(
					author$project$Perlin$grad,
					aaa,
					_Utils_Tuple3(xf, yf, zf)),
				A2(
					author$project$Perlin$grad,
					baa,
					_Utils_Tuple3(xf - 1, yf, zf)),
				u));
		var x2 = author$project$Perlin$lerp(
			_Utils_Tuple3(
				A2(
					author$project$Perlin$grad,
					aba,
					_Utils_Tuple3(xf, yf - 1, zf)),
				A2(
					author$project$Perlin$grad,
					baa,
					_Utils_Tuple3(xf - 1, yf, zf)),
				u));
		var y1 = author$project$Perlin$lerp(
			_Utils_Tuple3(x1, x2, v));
		var bab = p(
			(p(
				p(xi + 1) + yi) + zi) + 1);
		var x1_ = author$project$Perlin$lerp(
			_Utils_Tuple3(
				A2(
					author$project$Perlin$grad,
					aab,
					_Utils_Tuple3(xf, yf - 1, zf - 1)),
				A2(
					author$project$Perlin$grad,
					bab,
					_Utils_Tuple3(xf - 1, yf, zf - 1)),
				u));
		var bba = p(
			p(
				(p(xi + 1) + yi) + 1) + zi);
		var bbb = p(
			(p(
				(p(xi + 1) + yi) + 1) + zi) + 1);
		var x2_ = author$project$Perlin$lerp(
			_Utils_Tuple3(
				A2(
					author$project$Perlin$grad,
					abb,
				...
				A2(
					author$project$Perlin$grad,
					bbb,
					_Utils_Tuple3(xf - 1, yf - 1, zf - 1)),
				u));
		var y2 = author$project$Perlin$lerp(
			_Utils_Tuple3(x1_, x2_, v));
		return (author$project$Perlin$lerp(
			_Utils_Tuple3(y1, y2, w)) + 1) / 2;
	});
...
var author$project$Model$init = function (flags) {
	return _Utils_Tuple2(
		{
			currentEffect: author$project$Messages$NoiseEffect(
				author$project$Effects$build(
					{
						applyModifier: F3(
							function (eff, _n0, _n1) {
								return eff;
							}),
					...
					author$project$Effects$build(
						{
							...
							name: 'Fork Lightning',
							tick: author$project$Lightning$Update$tick
						})),
					author$project$Messages$CloudEffect(
					author$project$Effects$build(
						{
							applyModifier: F3(
								function (m, mod, val) {
							...
							mods: _List_fromArray(
								[
									_Utils_Tuple3(
									author$project$Messages$Extremity,
									'funkitude',
									function ($) {
										return $.extremity;
									}),
									_Utils_Tuple3(
									author$project$Messages$Speed,
									'speed',
									function ($) {
										return $.speed;
									})
...
var author$project$View$effectOption = function (metaEffect) {
	switch (metaEffect.$) {
		case 'CloudEffect':
...
var author$project$Effects$modConstructor = function (_n0) {
	var eff = _n0.a;
	return eff.modConstructor;
};
var author$project$Effects$model = function (_n0) {
	var eff = _n0.a;
	return eff.model;
};
		...
		return A2(
			...
			A2(
					...
					]),
				{
					...
					max: 1,
					min: 0,
					onChange: author$project$Messages$ModifierChanged(
						A2(author$project$Effects$modConstructor, effect, modifier)),
					step: elm$core$Maybe$Just(1.0e-2),
					thumb: mdgriffith$elm_ui$Element$Input$defaultThumb,
					value: prop(
						author$project$Effects$model(effect))
				}));
	});
...
var author$project$View$draw = F2(
	function (effect, otherEffects) {
		return _List_fromArray(
			[
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$text(
									'Current Effect: ' + author$project$Effects$name(effect)),
									A2(
									...
									_List_Nil,
									{
										label: A2(
											mdgriffith$elm_ui$Element$Input$labelAbove,
											_List_Nil,
											mdgriffith$elm_ui$Element$text('Choose New Effect')),
										onChange: author$project$Messages$UserSelectedEffect,
										options: A2(elm$core$List$map, author$project$View$effectOption, otherEffects),
									...
									A2(
										elm$core$List$map,
										author$project$View$modSlider(effect),
										author$project$Effects$modifiers(effect)))
								])),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_fromArray(
							...
							mdgriffith$elm_ui$Element$html(
								author$project$Effects$draw(effect)))
						])))
			]);
	});
